...
int main()
{
	...
	Shader screenShader("MyShaders/framebuffers_screen.vs", "MyShaders/framebuffers_screen_kernel_edge_detection.fs");
	...
	// 텍스쳐 로드 및 텍스쳐 객체 생성
	unsigned int cubeTexture = loadTexture("images/container.jpg"); // 큐브에 적용할 텍스쳐 객체의 참조 ID 저장
	...
	// off-screen 렌더링을 위해 생성해 둔 FBO, RBO 객체도 메모리 해제
