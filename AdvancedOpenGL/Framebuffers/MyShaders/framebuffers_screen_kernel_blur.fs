...
void main() {
  /* blur kernel post-processing 적용 */
  ...
  // kernel (= convolution matrix) 선언 및 초기화 (관련 설명 하단 참고) -> blur kernel
  float kernel[9] = float[](
  // row-major
  1.0 / 16, 2.0 / 16, 1.0 / 16, // row1
  2.0 / 16, 4.0 / 16, 2.0 / 16, // row2
  1.0 / 16, 2.0 / 16, 1.0 / 16  // row3
  );
