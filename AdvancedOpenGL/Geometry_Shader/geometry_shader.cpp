...
int main()
{
	...
	/* points primitive 의 VAO(Vertex Array Object), VBO(Vertex Buffer Object) 생성 및 바인딩(하단 VAO 관련 필기 참고) */
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		/* points primitive 그리기 */

		// points primitive 에 적용할 VAO 객체를 바인딩하여, 해당 객체에 저장된 VBO 객체와 설정대로 그리도록 명령
		glBindVertexArray(VAO);

		// points primitive 에 적용할 쉐이더 프로그램 객체 바인딩
		shader.use();

		// points primitive 그리기 명령
